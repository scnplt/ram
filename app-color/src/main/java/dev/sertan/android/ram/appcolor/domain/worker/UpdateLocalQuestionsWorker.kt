...
package dev.sertan.android.ram.appcolor.domain.worker
...
import dev.sertan.android.ram.appcolor.domain.usecase.UpdateLocalQuestionsUseCase
...
class UpdateLocalQuestionsWorker @AssistedInject constructor(
    ...
    companion object {
        ...
        fun uniqueStart(context: Context) {
            ...
            val request = PeriodicWorkRequestBuilder<UpdateLocalQuestionsWorker>(
                REPEAT_INTERVAL_DAY,
                TimeUnit.DAYS
