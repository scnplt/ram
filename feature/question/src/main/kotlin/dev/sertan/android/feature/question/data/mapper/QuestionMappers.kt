...
package dev.sertan.android.feature.question.data.mapper
...
internal fun QuestionEntity.toDto(): QuestionDto =
    QuestionDto(
        uid = uid,
        content = content,
...
internal fun NetworkQuestion.toEntity(): QuestionEntity =
    QuestionEntity(
        uid = uid!!,
        content = content!!,
